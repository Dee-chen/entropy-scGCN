...
multipleCreateInput<-function(my_dir,sure_dir,cluster1="cluster",cluster2="cluster"){
	...
	print(paste0("cluster1:",cluster1))
	print(paste0("cluster2:",cluster2))
	print(paste0("ncores:",cores_n))
	mclapply(allFiles,function(e) createInput(e,sure_dir,cluster1,cluster2),mc.cores=cores_n)->tmp;rm(tmp)
	#stopCluster(cl)
}
